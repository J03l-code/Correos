...
<head>
    ...
    <title>Error Interno (500) - QUITO 2026</title>
...
<body class="bg-[#F5F1E7] min-h-screen flex items-center justify-center p-6 text-center">
    <div class="max-w-md bg-white border border-gray-100 rounded-3xl p-8 shadow-xl space-y-6">
        <h1 class="text-6xl font-black text-[#FF5964] leading-none">500</h1>
        <h2 class="text-xl font-bold text-[#062B63]">Error del Servidor</h2>
        <p class="text-sm text-gray-500 font-semibold leading-relaxed">
            Ha ocurrido un problema interno en nuestros servidores. Por favor, intenta de nuevo más tarde.
        </p>
        <div>
