...
@section('breadcrumbs')
    <span class="text-gray-400">Panel</span> / <a href="{{ route('faqs.index') }}" class="text-gray-400 hover:text-[var(--primary)]">FAQs</a> / <span class="text-[var(--primary)]">Editar</span>
@endsection
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-xs text-gray-500 font-semibold mt-1">
            Modifica la pregunta o su respuesta asociada.
        </p>
    </div>
